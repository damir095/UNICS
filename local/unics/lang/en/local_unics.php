...
// Сообщение об отказе внешнего сервиса ИИ ([[ai-error-messages-design]]).
// Строка - ровно «{$a}», без единого слова вокруг: moodle_exception подставляет наш текст в
// языковую строку по идентификатору, и стандартная generalexceptionmessage добавляла бы
// «Исключение - ». Педагогу этот префикс говорит только о том, что что-то сломано в коде -
// ровно тот дефект, ради которого задача и делалась (найдено ревью 2026-08-25).
$string['aiservicefailed'] = '{$a}';
