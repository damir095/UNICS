...
final class arithmetic_checker_test extends \advanced_testcase {
    ...
    public function test_model_solution_cannot_confirm_its_own_wrong_key(): void {
        // Живая генерация 2026-08-22: «приведите 1/4 и 3/5 к общему знаменателю и вычислите
        // сумму» с вариантами от «1 3/20» до «1 6/20». Верный ответ 17/20 меньше единицы, то
        // есть его среди вариантов НЕТ вовсе, и задание надо отбросить. Модель ошиблась в
        // решении так же, как в ключе («5/20 + 20/20 = 25/20»), и подтвердила саму себя.
        //
        // Решение модели - не независимый источник: считать надо по операндам вопроса.
        $out = arithmetic_checker::verdict(
            'Приведите дроби 1/4 и 3/5 к общему знаменателю и вычислите сумму',
            ['1 3/20', '1 4/20', '1 5/20', '1 6/20'], 2, '1/4 + 3/5 = 5/20 + 20/20 = 25/20');
