...
Шаг 3. Три", $M));
        ...
        // Пробел в хвосте НЕ переходит через перенос строки: иначе проза, кончающаяся словом
        // «шаг», склеивалась со следующей строкой «1. ...», и три таких стыка брали порог без
        // единого блока «Шаг N.» (найдено ревью).
        $this->assertSame(0, $gen->artifact_count("Разберём по шагам. Первый шаг
1. Нагреть воду.", $M),
            'Стык «шаг» + перенос + «1.» засчитан за артефакт.');
