        ...
        $matrix = [
            ...
            'parent' => [
                ...
                'prevent' => array_merge(
                    ...
                    // ИСТОРИЯ: роль parent назначалась на системном контексте, и grade:viewall
                    // действовал сразу во всех курсах - родитель прямым URL получал персданные
                    // чужих детей ([[parent-leak-fix-design]]). С 2026-08-24 роль живет в контексте
                    // СВОЕГО ребенка ([[parent-role-scope]]), но запрет оставлен: он не мешает
                    // родителю (свои страницы гейтятся связью), а при случайном назначении роли на
                    // курс - а такой уровень роли по-прежнему разрешен - снова стал бы единственной
                    // преградой.
