...
class cat_session_manager {
     ...
     *
     * Публичные: то же число подставляют индикатор готовности и проверка здоровья, и три копии
     * уже начали расходиться (найдено ревью). Считать достижимую точность по одному пределу, а
     * вести проверку по другому - значит обещать методисту не то, что произойдет.
     */
