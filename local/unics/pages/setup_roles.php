...
// Колонки: Админ (региональн./районный — права идентичны),
// Методист (организации/районный — права идентичны),
// Педагог создающий курсы (editingteacher), Педагог non-editing (teacher),
// Учащийся, Родитель. Различие региональн./районный и орг./районный — только в скоупе.
$matrix_display = [
...
echo '<strong>Колонки «Админ» и «Методист»</strong> объединяют по две роли с идентичными правами, '
   . 'различающиеся только скоупом: Админ = региональный (регион) + районный (район); '
   . 'Методист = организации (организация) + районный (район). ';
echo '¹ Родитель видит заметки - только на просмотр; «Админ» = local/unics:manage у системного админа, '
   . 'у региональн./районного админа - manageorg со scope-проверкой. ';
